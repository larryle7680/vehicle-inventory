...
public class VehicleApp {
    ...
    public static void main(String[] args) {
        ...
        System.out.println();
        System.out.println("There are currently " + vehicleCounter + " Vehicles in the inventory.");
        System.out.println();
    ...
    public static void addVehicle() {
        ...
        for (int i = 0; i < vehicle.length; i++) {
            if (vehicle[i] == null) {
                ...
                long newVehicleID = theScanner.nextLong();
                ...
                float newPrice = theScanner.nextFloat();

                //Store the answer in a new array
                vehicle[i] = new Vehicle(newVehicleID, newMakeModel, newColor, newOdometerReading, newPrice);
